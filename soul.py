...
FORWARD_CHANNEL_ID = -1002214974751
CHANNEL_ID = -1002214974751
error_channel_id = -1002214974751
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*https://youtube.com/@y28gaming?si=942Dirus7ZKw1v6x*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*https://youtube.com/@y28gaming?si=942Dirus7ZKw1v6x*", parse_mode='Markdown')
